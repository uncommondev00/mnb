	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
				...
				<div class="row">
					<div class="col-md-9">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									{!! Form::label('staff_note', __('Cashier Code') . ':') !!}
									{!! Form::text('staff_note', 
									!empty($transaction)? $transaction->staff_note:null, ['class' => 'form-control', 'required', 'rows' => 3, 'placeholder' => __('Cashier Code')]); !!}
								</div>
							</div>
						</div>
					</div>
			...
			<div class="modal-footer">
				...
				<button type="submit" class="btn btn-primary" id="pos-save" onclick="delete_cookie();">@lang('sale.finalize_payment')</button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
