...
<section class="content no-print">
	{!! Form::open(['url' => route('store-request-stock'), 'method' => 'post', 'id' => 'stock_request_form' ]) !!}
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						{!! Form::select('transfer_location_id', $assigned_locations, null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required', 'id' => 'transfer_location_id']); !!}
					</div>
				</div>
				<div class="col-sm-4">
					<div class="form-group">
		...
		<div class="box-body">
			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					...
					id="stock_request_product_table">
						<thead>
							<tr>
