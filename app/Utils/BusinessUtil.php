...
class BusinessUtil extends Util
{
    ...
    public function newBusinessDefaultResources($business_id, $user_id)
    {
        ...
        //Add Senior Citizen for new business
        $customer2 = [
                        'business_id' => $business_id,
                        'type' => 'customer',
                        'name' => 'Senior Citizen',
    ...
    /**
     * Return the invoice layout details teleclick
     *
     * @param int $business_id
     * @param array $location_details
     * @param array $layout_id = null
     ...
     * @return location object
     */
    public function layoutInvoice($business_id, $location_id, $layout_id = 2)
    {
        $layout = null;
        if (!empty($layout_id)) {
            $layout = InvoiceLayout::find($layout_id);
    ...
    {
        return ['disable_pay_checkout' => 0, 'disable_draft' => 0, 'disable_express_checkout' => 0, 'hide_product_suggestion' => 1, 'hide_recent_trans' => 1, 'disable_discount' => 0, 'disable_order_tax' => 0, 'is_pos_subtotal_editable' => 0];
    }
