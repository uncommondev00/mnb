    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="{{ $request->segment(1) == 'stock_alert' ? 'active' : '' }} ">
          <a href="{{action('HomeController@stockAlert')}}" class="">
        ...
        auth()->user()->can('category.create') )
          <li class="treeview {{ in_array($request->segment(1), ['variation-templates', 'products', 'labels', 'import-products', 'import-opening-stock', 'selling-price-group', 'brands', 'units', 'categories', 'request-stock']) ? 'active active-sub' : '' }}" id="tour_step5">
            ...
            <ul class="treeview-menu">
              ...
              @can('sales_representative.view')
                <li class="{{ $request->segment(1) == 'categories-discount' ? 'active' : '' }}">
                  <a href="{{action('CategoryController@categoryDiscount')}}"><i class="fa fa-tags"></i> <span>@lang('Categories Discount') </span></a>
                </li>
              @endcan
              @can('product.view')
                <li class="{{ $request->segment(1) == 'request-stock' ? 'active' : '' }}"><a href="{{route('request-stock')}}"><i class="fa fa-list"></i>Request Stocks</a></li>
                <li class="{{ $request->segment(2) == 'requested' ? 'active' : '' }}"><a href="{{route('requested-stock')}}"><i class="fa fa-list"></i>Requested Stocks</a></li>
              @endcan
            </ul>
          </li>
        @endif
        ...
        @if(auth()->user()->can('sell.view') || auth()->user()->can('sell.create') || auth()->user()->can('direct_sell.access') )
          ...
          <li class="treeview {{  in_array( $request->segment(1), ['sells', 'unit_sells', 'voids', 'pos', 'sell-return', 'ecommerce', 'discount']) ? 'active active-sub' : '' }}" id="tour_step7">
            ...
            <ul class="treeview-menu">
              ...
              @can('sell.view')
                <li class="{{ $request->segment(1) == 'voids' && $request->segment(2) == null ? 'active' : '' }}" ><a href="{{action('VoidTransactionController@index')}}"><i class="fa fa-list"></i>Voided Transaction</a></li>
              @endcan
        ...
        @if(auth()->user()->can('purchase_n_sell_report.view') 
          ...
          <li class="treeview {{  in_array( $request->segment(1), ['reports']) ? 'active active-sub' : '' }}" id="tour_step8">
            ...
            <ul class="treeview-menu">
                <!--x reading-->
                <li class="{{ $request->segment(2) == 'x-reading' ? 'active' : '' }}" ><a href="{{action('ReportController@xReading')}}"><i class="fa fa-list-alt"></i>@lang('X Reading')</a></li>
                <!--z reading-->
                <li class="{{ $request->segment(2) == 'z-reading' ? 'active' : '' }}" ><a href="{{action('ReportController@zReading')}}"><i class="fa fa-list-alt"></i>@lang('Z Reading')</a></li>
              ...
              @can('profit_loss_report.view')
                ...
                <li class="{{ $request->segment(2) == 'discounted' ? 'active' : '' }}" ><a href="{{action('SellController@discounted_sales')}}"><i class="fa fa-money"></i>@lang('Discounted Sales')</a></li>
              @endcan
              ...
              @can('purchase_n_sell_report.view')
                ...
                <li class="{{ $request->segment(2) == 'purchase-report' ? 'active' : '' }}" ><a href="{{action('ReportController@getPurchaseReport')}}"><i class="fa fa-arrow-circle-down"></i>@lang('Stock Value Report')</a></li>
              @endcan
              ...
              @can('stock_report.view')
                ...
                <li class="{{ $request->segment(2) == 'opening-stocks-report' ? 'active' : '' }}" ><a href="{{action('ReportController@getproductOpeningStocksReport')}}"><i class="fa fa-database"></i>@lang('Opening Stocks Report')</a></li>
              @endcan
        ...
        <li class="treeview @if( in_array($request->segment(1), ['business', 'tax-rates', 'barcodes', 'invoice-schemes', 'business-location', 'invoice-layouts', 'printers', 'subscription']) || in_array($request->segment(2), ['tables', 'modifiers']) ) {{'active active-sub'}} @endif">
          ...
          <ul class="treeview-menu" id="tour_step3">
            ...
            <li class="{{ $request->segment(2) == 'business/points' ? 'active' : '' }}">
                <a href="{{action('BusinessController@edit_points')}}" id="tour_step2"><i class="fa fa-credit-card"></i> <span>Add Points</span></a>
            </li>
