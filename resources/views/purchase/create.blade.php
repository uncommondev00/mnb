...
<section class="content">
	...
	@component('components.widget', ['class' => 'box-primary'])
		<div class="row">
			<div class="col-sm-2">
				<div class="form-group">
					<button tabindex="-1" type="button" class="btn btn-link btn-supplier-product" data-href="{{route('supplier-products')}}"
            	data-container=".supplier_product_modal"><i class="fa fa-eye"></i> View Supplier Products</button>
				</div>
			</div>
			...
			<div class="col-sm-2">
            	...
            	data-container=".get_purchase_price_logs"><i class="fa fa-plus"></i> @lang( 'product.add_new_product' ) </button>
				</div>
			</div>
		</div>
		@php
		...
		<div class="row">
			...
			<table class="table">
				...
				<tr>
					<td>
						<div class="form-group">
						{!! Form::label('tax_id', __('purchase.purchase_tax') . ':') !!}<span style="color: red;">(Not Required!)</span>
...
<!-- quick product modal -->
<div class="modal fade supplier_product_modal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="modalTitle"></div>
...
@section('javascript')
	...
	<script type="text/javascript">
		 $(document).ready(function() {
		    ...
		    //save manual miscellaneous
    $(document).on('click', '.btn-supplier-product', function(e) {
        e.preventDefault();
    ...
    $(document).on('click', '.btn-add-selected', function(e) {
