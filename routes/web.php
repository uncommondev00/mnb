...
Route::middleware(['IsInstalled', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::get('/business/points', 'BusinessController@edit_points')->name('points.edit_points');
    Route::post('/business/points/', 'BusinessController@update_points');


    Route::get('/home', 'HomeController@index')->name('home');
    Route::get('/stock_alert', 'HomeController@stockAlert');
    Route::get('/home/get-totals', 'HomeController@getTotals');
    Route::get('/home/get-totals1', 'HomeController@getTotals');
    ...
    Route::resource('contacts', 'ContactController');
  	...
  	//additional
    Route::get('/contacts/suppliers-products/{supplier_id}', 'SupplierProductController@products');
    Route::post('/contacts/mass-add-products/{supplier_id}', 'SupplierProductController@massAddProducts');
    Route::post('/contacts/mass-remove-products/{supplier_id}', 'SupplierProductController@massRemoveProducts');
    Route::get('/view-suppliers-products', 'SupplierProductController@viewSupplierProducts')->name('supplier-products');
    ...
    Route::get('/purchases/{id}/get_pp_logs', 'PurchaseController@getPurchasePriceLogs');
    ...
    Route::get('/sells/discounted', 'SellController@discounted_sales');
    Route::resource('sells', 'SellController');

    //Per Unit Sells
    Route::resource('unit_sells', 'UnitSellController');

    //Voided Transaction
     Route::resource('voids', 'VoidTransactionController');

    //Z and X Reading Reports
    Route::get('/z_reading', 'XZReportController@create');
    Route::post('/z_reading/post', 'XZReportController@store');
    Route::get('/z_print', 'XZReportController@print_this');

    Route::get('x_reading', 'XZReportController@Xcreate');
    Route::post('/x_reading/post', 'XZReportController@store2');
    Route::get('/x_print', 'XZReportController@print_this2');
    Route::get('reports/xreading_print/{id}', 'XZReportController@print_again');

    Route::get('reports/zreading_print/{id}', 'XZReportController@print_again2');

    Route::get('reports/xreading_print', 'XZReportController@print_again');
    ...
    Route::get('/sells/{transaction_id}/print2', 'SellPosController@invoicePrint')->name('sell.invoicePrint');
    Route::get('/sells/pos/get-product-suggestion', 'SellPosController@getProductSuggestion');
    Route::get('/pos/price-checking', 'SellPosController@price_checking')->name('price-checking');
    ...
    Route::get('/reports/purchase-report', 'ReportController@getPurchaseReport');
    ...
    Route::get('/reports/x-reading', 'ReportController@xReading');
    Route::get('/reports/z-reading', 'ReportController@zReading');
    Route::get('/reports/opening-stocks-report', 'ReportController@getproductOpeningStocksReport');
    Route::get('/reports/print_stock', 'ReportController@printStockreport');
    ...
    Route::get('/denomination', 'DenominationController@getDenonimation');

    Route::get('/open_drawer', 'DenominationController@openDrawer');


    //for categories discount
    Route::get('categories-discount', 'CategoryController@categoryDiscount');

    Route::get('edit-categories-discount/{id}', 'CategoryController@editcategoryDiscount')->name('editcategoryDiscount');

    Route::post('save-categories-discount', 'CategoryController@savecategoryDiscount')->name('savecategoryDiscount');
	
  
  	//for request of stocks
    Route::get('request-stock', 'RosController@index')->name('request-stock');
    Route::get('request-stock/requested', 'RosController@requested_stock')->name('requested-stock');
    Route::get('request-stock/create', 'RosController@createRequestStock')->name('create-request-stock');
    Route::post('request-stock/store', 'RosController@storeRequestStock')->name('store-request-stock');
    Route::get('request-stock/edit/{ros_id}', 'RosController@editRequestStock')->name('edit-request-stock');
    Route::put('request-stock/update/{ros_id}', 'RosController@updateRequestStock')->name('update-request-stock');
    Route::get('request-stock/view-product/{ros_id}', 'RosController@viewRequestProducts')->name('view-request-products');


    //for customer product discount
    Route::get('products/create-customer-discount/{product_id}', 'CustomerProductDiscountController@create_customer_discount')->name('create-customer-discount');
    Route::post('products/store-customer-discount/{product_id}', 'CustomerProductDiscountController@store_customer_discount')->name('store-customer-discount');
    Route::delete('products/remove-customer-discount/{cpd_id}', 'CustomerProductDiscountController@remove_customer_discount')->name('remove-customer-discount');

    //stock alert view other stock
    Route::get('view-other-location-stock/{vld_id}', 'HomeController@viewOtherLocationStocks')->name('view-other-location-stock');
});
