  ...
  <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            <span class="info-box-text">{{ __('Suspendend Sales') }}</span>
            <span class="info-box-number suspend_sale" id="suspend_sale" style="font-size: 40px !important;">{{ $tc }}</span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
...
<section class="content no-print">
  <input type="hidden" id="suspend_sale" value="0">
	<div class="row">
		<div class="col-md-12 col-xs-12">
          ...
          <div>
              <div class="form-group">
                  {!! Form::label('cg_date_range1', __('report.date_range') . ':') !!}
                  {!! Form::text('date_range',NULL, ['placeholder' => __('lang_v1.select_a_date_range'), 'class' => 'form-control cg_date_range1', 'id' => 'cg_date_range1', 'readonly']); !!}
              </div>
          </div>
		</div>
	</div>
	...
	<div class="row">
    	<div class="col-md-4 col-sm-6 col-xs-12">
	      <div class="info-box">
	        ...
	        <div class="info-box-content">
	          <span class="info-box-text">{{ __('Total Stock Value ') }}</span>
            <span class="info-box-text text-sm">(Total Purchase - Purchase Return - Stock Adjustment)</span>
...
@section('javascript')
  <script type="text/javascript">
    // $(document).on('click', '#cg_date_range1', function() {
    //     alert(111);
    // });
