@foreach( $variations as $variation)
    <tr>
        ...
        <td>
            <a data-toggle="modal" id="view_pp_logs" data-container=".get_purchase_price_logs" data-href="{{action('PurchaseController@getPurchasePriceLogs',$variation->id)}}" style="cursor: pointer;" title="View Price Logs">{{ $product->name }} ({{$variation->sub_sku}})</a>
        ...
        <td>
            ...
            number_format($variation->default_purchase_price, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm purchase_unit_cost_without_discount input_number', 'required', 'readonly']); !!}
        </td>
        <td>
        ...
        <td>
            ...
            number_format($variation->default_purchase_price, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator), ['class' => 'form-control input-sm purchase_unit_cost input_number', 'required', 'readonly']); !!}
        </td>
        <td class="{{$hide_tax}}">
