...
<div class="table-responsive">
    ...
    id="purchase_entry_table">
        <thead>
              <tr>
                ...
                <th>@lang( 'purchase.unit_selling_price') (Before Tax)</th>
    ...
    @foreach($purchase->purchase_lines as $purchase_line)
        <tr>
            ...
            <td>
                @php 
                    $sprice = ($purchase_line->purchase_price_inc_tax/$purchase->exchange_rate) *  ($profit_percent/100 +1);
                @endphp
                <label>{{number_format($sprice, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator)}}</label>
