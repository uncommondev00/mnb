...
class Util
{
    ...
    */
    ...
    {
        // $payment_types = ['cash' => __('lang_v1.cash'), 'points' => __('Points'), 'card' => __('lang_v1.card'), 'cheque' => __('lang_v1.cheque'), 'bank_transfer' => __('lang_v1.bank_transfer'), 'other' => __('Voucher')];
        ...
        $payment_types = ['cash' => __('lang_v1.cash'), 'other' => __('Credit')];
