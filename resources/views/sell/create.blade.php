...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	...
	<input type="hidden" name="points_amount" id="points_amount" value="0" placeholder="min amount to gain points">
	<input type="hidden" name="points" id="points" value="0" placeholder="points to give">
