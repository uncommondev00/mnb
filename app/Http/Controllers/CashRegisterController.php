...
class CashRegisterController extends Controller
{
    ...
    public function postCloseRegister(Request $request)
    {
        try {
            ...
            $input['denom1000'] = $request->denom1000;
            $input['denom500'] = $request->denom500;
            $input['denom200'] = $request->denom200;
            $input['denom100'] = $request->denom100;
            $input['denom50'] = $request->denom50;
            $input['denom20'] = $request->denom20;
            $input['denom10'] = $request->denom10;
            $input['denom5'] = $request->denom5;
            $input['denom1'] = $request->denom1;
            $input['denom_25'] = $request->denom_25;
            $input['status'] = 'close';
