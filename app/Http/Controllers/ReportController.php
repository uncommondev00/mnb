    ...
    public function getProfitLoss(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $data['net_profit'] = $data['total_sell'] -
                                $data['total_purchase'] - $data['total_sell_discount'] - $data['total_expense'] -
    ...
    public function getStockReport(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($products)
                ...
                ->removeColumn('unit')
                ->removeColumn('id')
                ->rawColumns(['purchase_price','unit_price', 'total_transfered', 'total_sold',
        ...
        if ($request->ajax()) {
            $query = PurchaseLine::join(
                ...
                't.id'
                    ...
                    ->select(
                        ...
                        'purchase_lines.updated_at as date'
                    )
                    ->groupBy('purchase_lines.id');
            ...
            return Datatables::of($query)
                ...
                ->editColumn('date', function ($row) {
                     return $this->productUtil->format_date($row->date);
                 })
                 ->editColumn('opening_qty', function ($row) {
